local assets = {Asset("ANIM", "anim/books.zip")}

local prefabs = {"bookaura_proxy"}
...
local function bookaura_proxy_fn()
  ...
  TheFocalPoint.components.focalpoint:StartFocusSource(inst, nil, nil, 3, 4, -1, {
    ActiveFn = bookaura_zoom_fn
  })
...
return unpack(books), Prefab("bookaura_proxy", bookaura_proxy_fn)
